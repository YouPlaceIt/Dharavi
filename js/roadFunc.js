...
function reset(){
	...
	if (line.length>0){
		...
		poly.setOptions({strokeOpacity: 0.0});
...
function addRoad(){
	 ...
	 $.post("PHP/insert_road.php",{  owner:user, points:marked_byuser},
	 	function(data) {
...
function deleteRoad()
{
	 $.post("PHP/delete_own_roads.php",{idR:currRoad},
	 	function(data) {
